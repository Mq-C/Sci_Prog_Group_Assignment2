...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>EMSN177_FLEX_AOI01_P05MODFLMIT01_maxWaterDepth_v01.tif</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="intervals">
              ...
              <sld:ColorMapEntry label="> 5 - 8" quantity="8" color="#b400f5"/>
              <sld:ColorMapEntry label="> 8" quantity="31.466056823730469" color="#f500f5"/>
            </sld:ColorMap>
          </sld:RasterSymbolizer>
        </sld:Rule>
      </sld:FeatureTypeStyle>
