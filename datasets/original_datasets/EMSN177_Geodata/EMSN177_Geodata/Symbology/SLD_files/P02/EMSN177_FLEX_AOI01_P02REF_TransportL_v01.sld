...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" version="1.1.0">
  <NamedLayer>
    <se:Name>EMSN177_FLEX_AOI01_P02REF_TransportL_v01</se:Name>
    <UserStyle>
      <se:Name>EMSN177_FLEX_AOI01_P02REF_TransportL_v01</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>Highway</se:Abstract>
          </se:Description>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>Main road</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>Local roads</se:Name>
          <se:Description>
            <se:Title>Local roads</se:Title>
            <se:Abstract>Local roads</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>info</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>No driveway</se:Name>
          <se:Description>
            <se:Title>No driveway</se:Title>
            <se:Abstract>No driveway</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>info</ogc:PropertyName>
              <ogc:Literal>No driveway</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          <se:Name>Cart track</se:Name>
          <se:Description>
            <se:Title>Cart track</se:Title>
            <se:Abstract>Cart track</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>info</ogc:PropertyName>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              ...
              <se:SvgParameter name="stroke-linecap">butt</se:SvgParameter>
              <se:SvgParameter name="stroke-dasharray">0 5 4 0</se:SvgParameter>
            </se:Stroke>
          </se:LineSymbolizer>
        </se:Rule>
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>info</ogc:PropertyName>
              <ogc:Literal>Bridge and elevated highway</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#efa2a2</se:SvgParameter>
            </se:Fill>
          </se:TextSymbolizer>
        </se:Rule>
        <se:Rule>
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#e15d5d</se:SvgParameter>
            </se:Fill>
          </se:TextSymbolizer>
        </se:Rule>
        <se:Rule>
