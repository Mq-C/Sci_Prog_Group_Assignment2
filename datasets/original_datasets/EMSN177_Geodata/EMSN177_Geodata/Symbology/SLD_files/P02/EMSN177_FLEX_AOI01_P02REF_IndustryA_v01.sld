...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>EMSN177_FLEX_AOI01_P02REF_IndustryA_v01</se:Name>
    <UserStyle>
      <se:Name>EMSN177_FLEX_AOI01_P02REF_IndustryA_v01</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
        ...
        <se:Rule>
          <se:Name>Dam (collapsed)</se:Name>
          <se:Description>
            <se:Title>Dam (collapsed)</se:Title>
            <se:Abstract>Dam (collapsed)</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Electric power station</se:Name>
          <se:Description>
            <se:Title>Electric power station</se:Title>
            <se:Abstract>Electric power station</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
              <ogc:Literal>Electric power station</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Extraction mine</se:Name>
          <se:Description>
            <se:Title>Extraction mine</se:Title>
            <se:Abstract>Extraction mine</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Heating facility</se:Name>
          <se:Description>
            <se:Title>Heating facility</se:Title>
            <se:Abstract>Heating facility</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
              <ogc:Literal>Heating facility</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>Power substation</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
              <ogc:Literal>Power substation</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Processing facility</se:Name>
          <se:Description>
            <se:Title>Processing facility</se:Title>
            <se:Abstract>Processing facility</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>Pumping station</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
              <ogc:Literal>Pumping station</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          ...
          <se:Description>
            ...
            <se:Abstract>Quarry</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Sewage treatment plant</se:Name>
          <se:Description>
            <se:Title>Sewage treatment plant</se:Title>
            <se:Abstract>Sewage treatment plant</se:Abstract>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>obj_type</ogc:PropertyName>
              <ogc:Literal>Sewage treatment plant</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#448970</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
          <se:LineSymbolizer>
            <se:Stroke>
